...
const ContextItem = ({
  ...
  <span
    ...
    className="hotdeal_btn-icon relative p-3 m-1 transition-transform duration-300 ease-in-out bg-white hover:bg-black rounded-md"
  >
...
const ItemButtonHotdeal = () => {
  const [hoveredIndex, setHoveredIndex] = useState<number | null>(null);

  const listIcons = [
    { icon: <HiOutlineBookmark />, title: "Quick add" },
...
export default ItemButtonHotdeal;
